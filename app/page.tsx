        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-3 text-sm font-light text-gray-500">
              {t('home.requestBookPrompt')}<Link href="/request-book" className="text-[#2C5530] hover:underline ml-1">{t('home.requestBookLink')}</Link>
            </p>
          </div>
        </section>
              ...
              <div className="flex items-center gap-4 overflow-x-auto">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1">
                  {categories.map(cat => (
                    ...
                    >
                      {cat === 'all' ? t('home.categoryAll') : cat}
                    </button>
                  ))}
                </div>
                ...
                >
                  ...
                  {book.cover_url ? (
                    ...
                    <div className="aspect-[3/4] bg-gradient-to-br from-[#2C5530] to-[#234426]
                      ...
                      <span className="text-white text-2xl font-light opacity-20">{t('home.placeholderCover')}</span>
                    </div>
                  )}
                  ...
                  <div className="hidden md:absolute md:inset-0 md:bg-white md:bg-opacity-0 md:group-hover:bg-opacity-50
                    ...
                    >
                      {creatingConversation === book.id ? t('home.creatingChat') : t('home.startChat')}
                    </button>
                  </div>
                </div>
              ))}
              ...
              {characters.map(char => (
                ...
                >
                  ...
                  <p className="font-light text-xs text-gray-500 mb-3 text-center">
                    {t('home.fromBook', { title: char.book_title })}
                  </p>
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-[#2C5530] text-white rounded-lg
                             ...
                             disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {creatingCharConversation === char.id ? t('home.creatingChat') : t('home.startChat')}
                  </button>
                </div>
              ))}
            </div>
